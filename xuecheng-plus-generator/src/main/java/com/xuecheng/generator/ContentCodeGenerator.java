...
public class ContentCodeGenerator {
	...
	//数据库账号
	private static final String DATA_SOURCE_USER_NAME  = "huxufei";
	//数据库密码
	private static final String DATA_SOURCE_PASSWORD  = "huxufei";
	//生成的表
...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://localhost:3306/xuplus_" + SERVICE_NAME
